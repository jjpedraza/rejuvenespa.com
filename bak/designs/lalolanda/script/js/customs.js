jQuery(function($) {
	 ...
	 * Slick
	 */
	var url_condicion = document.domain+""+window.location.pathname.substring(0, window.location.pathname.lastIndexOf('index.html') + 1);
	var speed_condicionado = 500;
	var auto_speed_condicionado = 4500;

	switch(url_condicion) {
	    case 'previsualizar.usuariosazteca.com/980227/':
			/*Fabi*/
	        speed_condicionado = 100;
	        auto_speed_condicionado = 2500;
	        break;
	    	speed_condicionado = 500;
	        auto_speed_condicionado = 4500;
	        break;
	}

	if (typeof(speed_condicionado_editable) == "number" ) 
    { 
    	speed_condicionado = speed_condicionado_editable;
    }
    if (typeof(auto_speed_condicionado_editable) == "number" ) 
    { 
    	auto_speed_condicionado = auto_speed_condicionado_editable;
    }
	
	$('.slick-hero-slider').slick({
		dots: true,
		infinite: true,
		speed: speed_condicionado,
		slidesToShow: 1,
		slidesToScroll: 1,
		centerMode: true,
		infinite: true,
		...
		adaptiveHeight: true,
		autoplay: true,
		autoplaySpeed: auto_speed_condicionado,
		pauseOnHover: true,
	});
